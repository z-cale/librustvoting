 ...
 * It is used as the `gov_comm` field in MsgRegisterDelegation, since the toy
...
// The sighash is now sent as a field on MsgRegisterDelegation (msg.sighash).
...
/**
 * Build a valid MsgRegisterDelegation JSON body with real RedPallas
